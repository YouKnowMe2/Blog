...
<section class="mainlayout">
    <div class="flex justify-end items-end  text-white p-2">
        <a href="{{route('invoice.index')}}" class="bg-black p-2">Back</a>
    </div>
    <div class="header">
