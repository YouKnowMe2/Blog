...
class ClientController extends Controller
{
    ...
    {
        $clients = Client::where('user_id',Auth::user()->id)->with('tasks')->latest()->paginate(20);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('client.index')->with('success','Client has ben added');
    }
    ...
    {
        $pending_tasks = $client->tasks()->where('status', 'pending')->get();
