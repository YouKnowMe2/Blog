                ...
                <form action="{{route('create-property')}}" method="post" class="p-6 bg-white border-b border-gray-200"> @csrf
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input class="civanoglu-input" type="text" id="name_tr" name="name_tr" value="{{$property->name_tr}}">
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class="civanoglu-input"  name="sale" id="sale">
                                ...
                                <option {{$property->type == '0' ? 'selected = "selected' : ''}} value="0">Rent</option>
                                <option {{$property->type == '1' ? 'selected = "selected' : ''}} value="1">Sale</option>
                            </select>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class="civanoglu-input"  name="type" id="type">
                                ...
                                <option {{$property->type == '2' ? 'selected = "selected' : ''}} ="2">Villa</option>
                            </select>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <select class="civanoglu-input"  name="bedrooms" id="bedrooms">
                                ...
                                <option {{$property->type == '1+1' ? 'selected = "selected' : ''}} value="1+1">1+1</option>
                                <option {{$property->type == '2+1' ? 'selected = "selected' : ''}} value="2+1">2+1</option>
                                <option {{$property->type == '3+1' ? 'selected = "selected' : ''}} value="3+1">3+1</option>
                                <option {{$property->type == '4+1' ? 'selected = "selected' : ''}} value="4+1">4+1</option>
                                <option {{$property->type == '5+1' ? 'selected = "selected' : ''}} value="5+1">5+1</option>
                                <option {{$property->type == '6+1' ? 'selected = "selected' : ''}} value="6+1">6+1</option>
                            </select>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class="civanoglu-input"  name="bathrooms" id="bathrooms">
                                <option value="">Select bedrooms</option>
                                <option {{$property->type == '1' ? 'selected = "selected' : ''}} value="1">1</option>
                                <option {{$property->type == '2' ? 'selected = "selected' : ''}} value="2">2</option>
                                <option {{$property->type == '3' ? 'selected = "selected' : ''}} value="3">3</option>
                                <option {{$property->type == '4' ? 'selected = "selected' : ''}} value="4">4</option>
                                <option {{$property->type == '5' ? 'selected = "selected' : ''}} value="5">5</option>
                                <option {{$property->type == '6' ? 'selected = "selected' : ''}} value="6">6</option>
                            </select>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select class="civanoglu-input"  name="pool" id="pool">
                                ...
                                <option {{$property->type == '0' ? 'selected = "selected' : ''}} value="0">No</option>
                                <option {{$property->type == '1' ? 'selected = "selected' : ''}} value="1">Private</option>
                                <option {{$property->type == '2' ? 'selected = "selected' : ''}} value="2">Public</option>
                                <option {{$property->type == '3' ? 'selected = "selected' : ''}} value="3">Both</option>
                            </select>
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="civanoglu-input" name="overview_tr" id="overview_tr" cols="30" rows="3">{{$property->overview_tr}}</textarea>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="civanoglu-input" name="why_buy" id="why_buy" cols="30" rows="5">{{$property->why_buy}}</textarea>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="civanoglu-input" name="why_buy_tr" id="why_buy_tr" cols="30" rows="5">{{$property->why_buy_tr}}</textarea>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="civanoglu-input" name="description" id="description" cols="30" rows="10">{{$property->description}}</textarea>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea class="civanoglu-input" name="description_tr" id="description_tr" cols="30" rows="10">{{$property->description_tr}}</textarea>
